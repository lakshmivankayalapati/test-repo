...
abstract class AppLocalizations {
  ...
  /// Title for the first welcome screen
  ///
  /// In en, this message translates to:
  /// **'Pay Anywhere,\nInstantly & Easily'**
  String get welcomeScreenTitle1;

  /// Description for the first welcome screen
  ///
  /// In en, this message translates to:
  /// **'From UPI to bank transfer to phone number pay how you want, globally.'**
  String get welcomeScreenDescription1;

  /// Title for the second welcome screen
  ///
  /// In en, this message translates to:
  /// **'Your Money.\nOur Protection.'**
  String get welcomeScreenTitle2;

  /// Description for the second welcome screen
  ///
  /// In en, this message translates to:
  ...
  /// Title for the third welcome screen
  ///
  /// In en, this message translates to:
  /// **'What You See Is\nWhat You Pay'**
  String get welcomeScreenTitle3;

  /// Description for the third welcome screen
  ///
  /// In en, this message translates to:
